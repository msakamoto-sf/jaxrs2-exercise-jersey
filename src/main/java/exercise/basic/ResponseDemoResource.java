...
public class ResponseDemoResource {
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/created201
     * 
     * @return
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/seeother303
     * 
     * @return
     * @throws java.net.URISyntaxException
     */
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/tempredirect307
     * 
     * @return
     * @throws java.net.URISyntaxException
     */
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/custom500
     * 
     * @return
     */
    @GET
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/custom999
     * 
     * @return
     */
    @GET
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/binarydl -o out.bin
     * 
     * @return
     * @throws java.net.URISyntaxException
     */
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-response-demo/as_sjis -o sjis.txt
     * 
     * @return
     * @throws java.net.URISyntaxException
     */
