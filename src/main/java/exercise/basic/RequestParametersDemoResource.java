...
public class RequestParametersDemoResource {
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-request-parameters-demo/item/10
     * 
     * curl -v -X GET "http://127.0.0.1:8580/myapp/ex1/typical-request-parameters-demo/item/10?age=20&is_admin=true&
     * name=alice"
     * 
     * @param uriInfo
     * @param id
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/typical-request-parameters-demo/item/10/admin
     * 
     * @param id
     * @param uriInfo
     * @return
    ...
    /**
     * curl -v -X POST -d name=clice -d age=15 -d is_admin=true
     * http://127.0.0.1:8580/myapp/ex1/typical-request-parameters-demo/item/10
     * 
     * @param uriInfo
     * @param id
     * @param newName
