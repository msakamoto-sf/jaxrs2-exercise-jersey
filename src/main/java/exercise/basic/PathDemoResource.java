...
public class PathDemoResource {
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/resource-paths-demo
     * 
     * @param info
     * @return
     */
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/resource-paths-demo/sub1
     * 
     * @param info
     * @return
     */
    ...
    // }
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/resource-paths-demo/sub/sub2
     */
    @GET
    @Path("sub/sub2")
