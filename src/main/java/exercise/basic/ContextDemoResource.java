...
public class ContextDemoResource {
    ...
    /**
     * curl -v -X GET -b "c1=c1v;c2=c2va;c2=c2vb;c3=c3v" -H "X-Custom-Header-Without-Value;" -H "X-Custom-Header1: hv1a"
     * -H "X-Custom-Header1: hv1b" -H "X-Custom-Header2: hv2"
     * "http://127.0.0.1:8580/myapp/ex1/context-demo/pp1a/pp1b/pp2a/pp2b/pp3?q1=q1va&q1=q1vb&q1=q1vc&q2=q2va&q2=q2vb&q3=q3v"
     * 
     * @param info
     * @return
     */
