...
public class ExceptionDemoResource {
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/exception-demo/demo1
     * 
     * @return
     */
    @GET
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/exception-demo/demo2
     * 
     * @return
     */
    @GET
    ...
    /**
     * curl -v -X GET http://127.0.0.1:8580/myapp/ex1/exception-demo/demo3
     * 
     * @return
     */
    @GET
